...
namespace Constant.Rewriting.CodeGen
{
    public static class ILPostProcessUtility
    {
        ...
        internal static ILPostProcessResult GetResult(
    ...
    {
        private const string _SYSTEM_PRIVATE_CORE_LIB = "System.Private.CoreLib";
        private AssemblyNameReference _correctCorlib;

        public PostProcessorReflectionImporter(ModuleDefinition module) : base(module)
        {
            _correctCorlib = module.AssemblyReferences.FirstOrDefault(a =>
                a.Name == "mscorlib" || a.Name == "netstandard" || a.Name == _SYSTEM_PRIVATE_CORE_LIB);
        }

        public override AssemblyNameReference ImportReference(AssemblyName reference)
        {
            if (_correctCorlib != null && reference.Name == _SYSTEM_PRIVATE_CORE_LIB)
